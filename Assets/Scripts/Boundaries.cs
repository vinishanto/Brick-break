...
public class Boundaries : MonoBehaviour
{
    ...
    // Add tag to The bottom collider to identify game over
        bottomCollider.gameObject.tag = "FallCheck";
    ...
    //Change our scale and positions to match the edges of the screen...   
        ...
        bottomCollider.position = new Vector3(cameraPos.x, cameraPos.y - screenSize.y - (bottomCollider.localScale.y * 0.6f), zPosition);
    }
}
